...
A: Yes! The underlying Zarr and Xarray multi-group design is fully compatible with multiscale pyramids (downsampling pyramids with spatial stride 2x2, 4x4). You can generate downsampled spatial subgroups using standard Dask coarsening:
...
- Exact Mathematical Zero-Difference (Difference = 0.0): Verified between raw binary fields (EPyGrAM/ecCodes) and converted Zarr stores.
